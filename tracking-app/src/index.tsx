...
app.post('/api/ai/suggest-tag', authMiddleware, async (c) => {
  ...
  // 1. 优先尝试 Cloudflare Workers AI（需登录 Cloudflare 且已联网）
  if (c.env.AI) {
    try {
